import {cart, addtoCart, checkoutCount} from '../data/cart.js';
...
.forEach((button)=>{
    ...
    button.addEventListener('click', ()=>{
      ...
      const quantityCount = document.querySelector(`.js-quantity-selector-${productId}`);
      
      let quantity = Number(quantityCount.value);
